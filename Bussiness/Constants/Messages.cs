...
namespace Bussiness.Constants
{
    public static class Messages
    {
        ...
        public static string MaximumImageCountError = "Maximum image count limit has been reached. !";
        public static string IncorrectFileExtension = "Incorrect file extension !";
        public static string IncorrectFileContent = "Incorrect file content !";
